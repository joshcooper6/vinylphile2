...
export default function AlbumCard(props) {
  ...
  return (
    <div
      ...
      className={`flex p-4 gap-2 hover:scale-105 cursor-pointer transease justify-around rounded-md bg-blue-900 text-blue-200 md:flex-col w-11/12 max-w-[400px] md:w-[200px]`}
    >
